...
class CalvoCNN(nn.Module):
    def __init__(self, fc_dim=128, num_classes=2):
        ...
        # assuming input image resized to 248×248 → after 3 poolings → ~31×31
        self.flatten_dim = 16 * 31 * 31
...
if __name__ == "__main__":
    ...
    p.add_argument("--fc_dim", type=int, default=128, help="Fully connected layer size (128/256/512)")
    args = p.parse_args()
